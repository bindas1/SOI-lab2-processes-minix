...
PRIVATE int time_left = 0;	/* starts with no time*/
 ...
 */
  ...
  switch (rdy_head[USER_Q]->p_group)
  {
  case 0: time_left = I_GROUP_TIME; break;
  case 1: time_left = C_GROUP_TIME; break;
  case 2: time_left = M_GROUP_TIME; break;
  default: time_left = I_GROUP_TIME; break;
  }
  pick_proc();
}
