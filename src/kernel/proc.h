...
struct proc {
  ...
  char p_group;			/* scheduling group of this process: I/C/M */
...
#define DEFAULT_GROUP 0	/* All processes start in interactive group */
#define I_GROUP_TIME 7 /* number of time quants of interactive group*/
#define C_GROUP_TIME 3 /* number of time quants of calculating group*/
#define M_GROUP_TIME 1 /* number of time quants of massive i/o group*/
